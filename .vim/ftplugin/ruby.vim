...
" xmpfilter
"   see xmpfilter help file for details.
"    apply xmpfilter to current row.
map <silent> <F1> !xmpfilter -a<cr>
nmap <silent> <F1> V<F1>
imap <silent> <F1> <ESC><F1>a

"    add # => mark to current row.
vmap <silent> <F2> !xmpfilter -m<cr>
nmap <silent> <F2> V<F2>
imap <silent> <F2> <ESC><F2>a

"    remove # => mark from current row.
vmap <silent> <F3> ms:call RemoveRubyEval()<CR>
nmap <silent> <F3> V<F3>
imap <silent> <F3> <ESC><F3>a

"    apply xmpfilter to window buffer
nmap <silent> <F5> mzggVG!xmpfilter -a<cr>'z
